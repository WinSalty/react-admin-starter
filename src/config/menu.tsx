  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        orderNo: 9,
        type: 'menu',
        permissionCode: 'credential:batch:view',
      },
      {
        key: 'credential-items',
        path: '/system/credentials/items',
        label: '凭证明细',
        icon: <KeyOutlined />,
        orderNo: 10,
        type: 'menu',
        permissionCode: 'credential:item:view',
      },
      {
        key: 'credential-extract-links',
        path: '/system/credentials/extract-links',
        label: '提取链接',
        icon: <LinkOutlined />,
        orderNo: 11,
        type: 'menu',
        permissionCode: 'credential:extract-link:view',
      },
      {
        ...
        orderNo: 12,
        type: 'menu',
        permissionCode: 'credential:category:view',
      },
      {
        key: 'credential-import-tasks',
        path: '/system/credentials/import-tasks',
        label: '导入任务',
        icon: <ImportOutlined />,
        orderNo: 13,
        type: 'menu',
        permissionCode: 'credential:import-task:view',
      },
      {
        key: 'credential-redeem-records',
        path: '/system/credentials/redeem-records',
        label: '兑换记录',
        icon: <FileSearchOutlined />,
        orderNo: 14,
        type: 'menu',
        permissionCode: 'credential:redeem-record:view',
      },
      {
        key: 'points-audit',
